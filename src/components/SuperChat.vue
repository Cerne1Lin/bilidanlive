...
function colorByPrice(p: number) {
    if (p < 50)
        return { front: Colors.SC_BLUE_FRONT, back: Colors.SC_BLUE_DARK };
    if (p < 100)
        return {
            front: Colors.SC_GREYBLUE_FRONT,
            back: Colors.SC_GREYBLUE_DARK,
        };
    if (p < 500)
        return { front: Colors.SC_YELLOW_FRONT, back: Colors.SC_YELLOW_DARK };
    if (p < 1000)
        return { front: Colors.SC_ORANGE_FRONT, back: Colors.SC_ORANGE_DARK };
